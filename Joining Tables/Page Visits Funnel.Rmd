...
visit_no_cart_percent <- nrow(visit_no_cart) / total_visits
...
total_cart_no_checkout <- nrow(cart_no_checkout)
```

```{r error=TRUE}
# calculate cart_no_checkout_percent here:
cart_no_checkout_percent <- total_cart_no_checkout / total_carts
...
total_checkout <- nrow(checkout_purchase)
total_checkout
```
...
checkout_no_purchase_percent <- nrow(checkout_no_purchase) / total_checkout
